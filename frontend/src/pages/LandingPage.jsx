        ...
        <header className="w-full bg-white/95 backdrop-blur-md border-b border-[#c0c7d4]/40">
          <div className="h-20 max-w-[1280px] mx-auto px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-[18px] text-[#005ea4] tracking-tight leading-none">
                  GridVault
                </span>
                <span className="text-[11px] font-bold tracking-[0.05em] text-[#404752] uppercase">
                  Clinical EMR
                </span>
              </div>
            </div>
            ...
            <nav className="hidden xl:flex items-center gap-5 text-[13px] font-semibold tracking-[0.01em]">
              <a
                href="#solutions"
                className="text-[#404752] hover:text-[#005ea4] transition-colors"
              >
                Solutions
              </a>
              ...
              <a href="#offline" className="text-[#404752] hover:text-[#005ea4] transition-colors">
                Offline Architecture
              </a>
              <a href="#security" className="text-[#404752] hover:text-[#005ea4] transition-colors">
                Trust & Security
              </a>
              <a href="#pricing" className="text-[#404752] hover:text-[#005ea4] transition-colors">
                Pricing
              </a>
            </nav>
            ...
            <div className="flex items-center gap-3">
              <a
                href="/login"
                className="hidden xl:inline-flex items-center text-[13px] font-semibold text-[#404752] hover:text-[#005ea4] px-3 py-2 rounded transition-colors"
              >
                Hospital Portal Login
              </a>
              <a
                href="/login"
                className="hidden xl:inline-flex items-center justify-center bg-[#005ea4] hover:bg-[#0077ce] text-white text-[13px] font-semibold px-5 py-2.5 rounded-lg shadow-sm transition-all"
              >
                Request Demo
              </a>
          ...
          {mobileMenuOpen && (
            <div className="xl:hidden bg-white border-t border-[#c0c7d4]/40 px-6 py-4 space-y-3">
              <a
                href="#solutions"
                className="block text-[14px] font-semibold text-[#404752] hover:text-[#005ea4]"
              >
                Solutions
              </a>
              <a
              ...
              <a
                href="/login"
                className="block w-full text-center bg-[#005ea4] text-white text-[14px] font-semibold py-2.5 rounded-lg mt-4"
              >
                Request Demo
              </a>
            </div>
      ...
      <main className="w-full pt-28 flex-1 bg-[#faf8ff]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="text-[16px] text-[#404752] max-w-xl mb-8 leading-relaxed">
                  Hospital staff can access patient records by role and ward, with tamper-proof
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto mb-10">
                  <a
                    href="/login"
                    className="inline-flex items-center justify-center bg-[#005ea4] hover:bg-[#0077ce] text-white text-[14px] font-semibold px-8 py-3.5 rounded-lg shadow-sm transition-all text-center"
                  >
                    Request Demo
                  </a>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-6 border-t border-[#c0c7d4]/30 w-full">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold tracking-[0.05em] text-[#131b2e]">
                      99.98% Uptime Across State Grids
                    </span>
                  </div>
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-xl bg-[#f2f3ff]">
                  ...
                  <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-md rounded-xl p-3 sm:p-4 shadow-lg max-w-[260px]">
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[11px] font-bold tracking-[0.05em] text-[#b6171e] uppercase">
                          Emergency Override Active
                        </span>
                      </div>
                      <span className="text-[11px] font-bold text-[#404752]">00:04m</span>
                    </div>
                    <p className="text-[12px] font-semibold text-[#131b2e]">
                      Dr. O. Adeyemi - Ward 3 ICU
                    </p>
                    <div className="flex items-center justify-between text-[12px] text-[#404752] mt-1">
                      <span>
                        Audit ID: <strong className="font-mono text-[#131b2e]">#GV-9042</strong>
                      </span>
                  ...
                  <div className="absolute bottom-4 left-4 bg-white/95 backdrop-blur-md rounded-xl p-3 sm:p-4 shadow-lg max-w-[280px]">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-[11px] font-bold tracking-[0.05em] text-[#006a62] uppercase">
                        Sync Status: Offline Cache Active
                      </span>
                    </div>
                    <p className="text-[12px] font-semibold text-[#131b2e]">
                      48 patient charts queued - Zero data loss
                    </p>
          ...
          <div className="max-w-[1280px] mx-auto px-6 py-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-y md:divide-y-0 md:divide-x divide-[#c0c7d4]/40">
              ...
              <div className="flex flex-col pt-4 md:pt-0 md:px-6">
                <span className="text-[36px] font-semibold text-[#006a62] tracking-tight">
                  0.4s
                </span>
                <span className="text-[12px] font-semibold text-[#131b2e] mt-1">
                  Average Record Retrieval
                </span>
                <span className="text-[12px] text-[#404752]">Instant chart lookup at bedside</span>
              </div>
              <div className="flex flex-col pt-4 md:pt-0 md:px-6">
                <span className="text-[36px] font-semibold text-[#005ea4] tracking-tight">
                  100%
                </span>
                <span className="text-[12px] font-semibold text-[#131b2e] mt-1">
          ...
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-[16px] text-[#404752] max-w-2xl mx-auto leading-relaxed">
                Built for Nigerian hospitals. Role-based access, emergency overrides, offline
                resilience, and tamper-proof audit logs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg border border-[#e2e7ff] shadow-sm hover:shadow-md transition-all">
                ...
                <h3 className="text-[20px] font-semibold text-[#131b2e] mb-3">
                  Role-Based Access Control
                </h3>
                <p className="text-[14px] text-[#404752] leading-relaxed">
                  Only authorized staff see assigned patients. Doctors, nurses, clerks and admins
                  have isolated views based on ward and shift assignment.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg border border-[#e2e7ff] shadow-sm hover:shadow-md transition-all">
                ...
                <p className="text-[14px] text-[#404752] leading-relaxed">
                  Instant access when time-critical. Every override is cryptographically logged with
                  timestamp, staff ID and justification reason. Impossible to hide.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg border border-[#e2e7ff] shadow-sm hover:shadow-md transition-all">
                ...
                <p className="text-[14px] text-[#404752] leading-relaxed">
                  Ward power fails. Internet goes down. Your cached records stay accessible. Zero
                  data loss. Automatic sync when connection returns.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full bg-[#005ea4] py-16 lg:py-24">
          <div className="max-w-[1280px] mx-auto px-6 text-center">
            ...
            <a
              href="/login"
              className="inline-flex items-center justify-center bg-white hover:bg-[#f2f3ff] text-[#005ea4] text-[14px] font-bold px-10 py-4 rounded-lg shadow-md transition-all"
            >
        ...
        <div className="max-w-[1280px] mx-auto px-6 py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-10 border-b border-[#c0c7d4]/30">
            <div className="space-y-4 lg:col-span-1">
              ...
              <p className="text-[12px] text-[#404752] leading-relaxed">
                Offline-first clinical infrastructure for Nigerian hospitals, multi-center health
                systems, and critical care units.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[14px] text-[#404752]">
                ...
                <li>
                  <a href="#" className="hover:text-[#005ea4] transition-colors">
                    Lab Integration Engine
                  </a>
                </li>
                <li>
                  <a href="#" className="hover:text-[#005ea4] transition-colors">
                    ICD-11 Coding Assist
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-[12px] text-[#404752]">
                ...
                <li className="pt-1">
                  <span className="text-[11px] font-bold text-[#005ea4] block">
          ...
          <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-[12px] text-[#404752]">
              2026 GridVault Technologies Ltd. Clinical infrastructure for Nigerian healthcare.
            </p>
