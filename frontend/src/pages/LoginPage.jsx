          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 rounded-xl shadow-xl overflow-hidden bg-white">
            ...
            <div className="lg:col-span-5 relative flex flex-col justify-between p-6 md:p-10 bg-[#f2f3ff] overflow-hidden order-2 lg:order-1">
              <div
                ...
                style={{
                  backgroundImage:
                    'radial-gradient(circle at 10% 20%, rgba(0, 94, 164, 0.08) 0%, transparent 60%), radial-gradient(circle at 90% 80%, rgba(0, 106, 98, 0.06) 0%, transparent 50%)'
                }}
              ></div>
              ...
              <div className="relative z-10 flex flex-col gap-4">
                ...
                <div className="mt-1">
                  <p className="text-[18px] font-semibold text-[#005ea4] tracking-tight">
                    GridVault EHR v4.8
                  </p>
                  <p className="text-[14px] text-[#404752] mt-1">
                ...
                <div className="relative h-56 md:h-64 w-full">
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-4 text-[#eef0ff]">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <p className="text-[12px] font-bold tracking-[0.02em] text-[#66d9cc] uppercase">
                        St. Nicholas & Teaching Centers
                      </p>
                    </div>
                    <p className="text-[20px] font-semibold text-[#eef0ff] leading-tight">
                      Ward-Synchronized Electronic Charts
                    </p>
                    <p className="text-[12px] text-[#d2d9f4] mt-1 line-clamp-2">
                      Real-time vital diagnostics, medication administration records, and
                      role-enforced telemetry.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative z-10 p-4 rounded-lg bg-white shadow-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[#404752] mt-0.5 leading-relaxed">
                    Your verified credential bundle deterministically provisions decryption keys for
                    assigned ward beds. Unassigned patient dossiers remain cryptographically
                    inaccessible.
                  </p>
                </div>
              </div>
              ...
              <div className="relative z-10 mt-4 pt-3 border-t border-[#c0c7d4]/40 flex items-center justify-between text-[11px] font-bold text-[#707783]">
                <span className="flex items-center gap-1">
                  ...
                  Terminal Session:{' '}
                  <span className="font-mono text-[#131b2e] ml-1">NG-LOS-0498</span>
                </span>
            ...
            <div className="lg:col-span-7 p-6 md:p-10 flex flex-col justify-center bg-white order-1 lg:order-2">
              ...
              {toastMessage && (
                <div
                  className={`mb-6 px-4 py-3 rounded-lg text-[14px] font-semibold flex items-center gap-2 ${
                    toastType === 'danger'
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative flex items-center">
                      <span className="absolute left-3 text-[#707783] pointer-events-none">
                        {Icons.badge}
                      </span>
                      <input
                        type="text"
        ...
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] font-bold text-[#707783]">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="hover:text-[#005ea4] transition-colors">
              Clinical Service Desk: +234 1 800 7233
            </a>
            <span className="text-[#c0c7d4]">•</span>
            <a href="#" className="hover:text-[#005ea4] transition-colors">
